...
== Schema
  ...
  Product
    ...
    high_res_images: Product images
...
== Usage
Install this gem and mount the engine in your desired namespace
...
status in the header, or hook with unobstrusive javascript a quicklook.
...
* Sorting options per dynamic category
* Pagination
* More Caching layers
